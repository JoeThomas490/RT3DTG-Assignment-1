...
Robot::Robot(float fX, float fY, float fZ, float fRotY)
{
	...
	m_hPelvisComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/pelvis.x", "robot_pelvis"));
	m_hBodyComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/body.x", "robot_body"));

	m_hLeftShoulderComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/left_shoulder.x", "robot_left_shoulder"));
	m_hLeftElbowComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/left_elbow.x", "robot_left_elbow"));
	m_hLeftWristComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/left_wrist.x", "robot_left_wrist"));

	m_hRightShoulderComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/right_shoulder.x", "robot_right_shoulder"));
	m_hRightElbowComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/right_elbow.x", "robot_right_elbow"));
	m_hRightWristComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/right_wrist.x", "robot_right_wrist"));

	m_hNeckComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/neck.x", "robot_neck"));

	m_hLeftHipComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/left_hip.x", "robot_left_hip"));
	m_hLeftKneeComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/left_knee.x", "robot_left_knee"));
	m_hLeftAnkleComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/left_ankle.x", "robot_left_ankle"));

	m_hRightHipComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/right_hip.x", "robot_right_hip"));
	m_hRightKneeComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/right_knee.x", "robot_right_knee"));
	m_hRightAnkleComponent.SetMesh(MeshManager::s_pMeshManager->LoadResources("Resources/Robot/right_ankle.x", "robot_right_ankle"));
